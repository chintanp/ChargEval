...
# -*- coding: utf-8 -*-
#
# WSDOT-EVSE documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'WSDOT-EVSE.tex', 'WSDOT-EVSE Documentation',
...
man_pages = [
    (master_doc, 'wsdot-evse', 'WSDOT-EVSE Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WSDOT-EVSE', 'WSDOT-EVSE Documentation',
     author, 'WSDOT-EVSE', 'One line description of project.',
     'Miscellaneous'),
]
